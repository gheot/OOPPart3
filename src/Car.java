...
public class Car extends transport {
    ...
    public String toString() {
        return getBrand() + ' ' + getModel() +
                ...
                " л, цвет кузова - " + getColor() + ", " + getProductionYear() +
                " года выпуска, " +
                " страна сборки - " + getProductionCountry() + ", коробка передач: " + typeOfTransmission + ", тип кузова:  " +
    ...
    public void refill() {
        System.out.println("Можно заправлять бензином, дизелем на заправке или заряжать на специальных парковках.");
